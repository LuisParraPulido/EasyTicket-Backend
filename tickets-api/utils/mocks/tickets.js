const ticketsMock = [
  ...
  },
  {
    ...
    "price":"$1191750.68",
    "Qr":"http://dropbox.com/viverra.js?pellentesque=libero&viverra=rutrum&pede=ac",
    "user":[
      {}
    ]
    },
    ...
    "price":"$2929539.88",
    "Qr":"https://narod.ru/lacinia/aenean/sit/amet/justo.png?leo=in&odio=faucibus&condimentum=orci&id=luctus&luctus=et&nec=ultrices&molestie=posuere&sed=cubilia&justo=curae",
    "user":[{}]
    },
    ...
    "returning":[
      {
        ...
        "hour":"2:53 PM",
        "from":"Jönköping",
        "to":"La Chapelle-sur-Erdre",
        "stops":1,
        "travelTime":"10:22 AM"
      },
    ],
    "price":"$8682828.43",
    "Qr":"http://webmd.com/sed/tristique/in/tempus.html?ut=dapibus&tellus=augue&nulla=vel&ut=accumsan&erat=tellus&id=nisi&mauris=eu&vulputate=orci&elementum=mauris&nullam=lacinia&varius=sapien&nulla=quis&facilisi=libero&cras=nullam&non=sit&velit=amet&nec=turpis&nisi=elementum&vulputate=ligula&nonummy=vehicula&maecenas=consequat&tincidunt=morbi&lacus=a&at=ipsum&velit=integer&vivamus=a&vel=nibh&nulla=in&eget=quis&eros=justo&elementum=maecenas&pellentesque=rhoncus&quisque=aliquam&porta=lacus&volutpat=morbi&erat=quis&quisque=tortor&erat=id&eros=nulla&viverra=ultrices&eget=aliquet&congue=maecenas&eget=leo&semper=odio",
    "user":[{}]
    },
